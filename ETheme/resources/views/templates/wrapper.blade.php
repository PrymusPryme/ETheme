...
$create_url = 'https://panel.pithonpvp.com/admin/servers/new'; // url to create server                     //
																					 //
$enable_our_website = true; // true or false (enable menu link to main website)      //
$url_main_website = 'https://pithonpvp.com'; // url main website (if enabled)             //
																					 //
$show_graphics = true; // true or false (enable graphics on main page)               //
$show_statistic = false; // true or false (enable statistic on main page)             //
																					 //
///////////////////////////////////////////////////////////////////////////////////////
///////////////////////////
...
<html>
    ...
    <body class="{{ $css['body'] ?? 'bg-neutral-50' }}">
		...
		setInterval(function(){
			...
			if($('.fNmetC')[0]) $('.fNmetC')[0].innerHTML = '<p class="kbxq2g-3 fNmetC">© 2015 - 2022&nbsp;<a rel="noopener nofollow noreferrer" href="https://pterodactyl.io" target="_blank" class="kbxq2g-4 hcJQtJ">Pterodactyl Software</a></p>';
			if($('.fFcOT')[0]) $('.fFcOT')[0].innerHTML = '<p class="kbxq2g-3 fNmetC">© 2015 - 2021&nbsp;<a rel="noopener nofollow noreferrer" href="https://pterodactyl.io" target="_blank" class="kbxq2g-4 hcJQtJ">Pterodactyl Software</a><br>Theme by <img style="height:14px;display:inline-block;" src="/assets/themes/pithon.png"> <a style="display:inline-block;" href="https://discord.gg/C5Ex7cJU5r" class="kbxq2g-4 hcJQtJ">Enigma prod.</a></p>';
		},500);
